...
%bcond_with dpdk
# To enable DOCA support, specify '--with doca' when building
%bcond_with doca
...
%endif
%if %{with doca}
%{!?doca_datadir:%define doca_datadir /opt/mellanox/doca}
%endif

# Do a static build using '--with static'
%bcond_with static
...
BuildRequires: mlnx-dpdk-devel >= 22.11
...
%endif
%if %{with doca}
        --with-doca=$(dirname %{doca_datadir}) \
%endif
%if %{with afxdp}
        --enable-afxdp \
%endif
